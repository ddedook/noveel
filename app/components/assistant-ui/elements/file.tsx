...
const fileVariants = cva(
  "aui-file-root inline-flex items-center gap-3 rounded-lg transition-colors",
  {
    variants: {
      variant: {
        outline: "border-border hover:bg-default/50 border",
        ghost: "hover:bg-default/50",
        muted: "bg-default/50 hover:bg-default/70",
      },
      size: {
...
function FileDownload({
  ...
  return (
    <a
      ...
      className={cn(
        "text-muted hover:bg-default hover:text-foreground shrink-0 rounded-md p-1 transition-colors",
        className,
      )}
      {...props}
    >
