    ...
    >
      {!loaded && !error && (
        <div
          ...
          className="bg-default/50 absolute inset-0 flex items-center justify-center"
        >
          <ImageIcon className="text-muted size-8 animate-pulse" />
        </div>
      )}
      {error ? (
        <div
          data-slot="image-preview-error"
          className="bg-default/50 flex min-h-32 items-center justify-center p-4"
        >
...
function ImageFilename({
  ...
  return (
    <span
      ...
      className={cn(
        "text-muted block truncate px-2 py-1.5 text-xs",
        className,
      )}
      {...props}
    >
        ...
        createPortal(
          ...
          >
            ...
            <button
              ...
              className="text-muted hover:text-foreground bg-background/80 absolute end-4 top-4 cursor-pointer rounded-md p-2"
            >
...
function ImageGenerating({ className }: { className?: string }) {
  return (
    <div
      ...
      className={cn(
        "bg-default/50 flex min-h-32 items-center justify-center p-4",
        className,
      )}
    >
      <Loader2Icon className="text-muted size-8 animate-spin" />
...
function ImageContentFilterError({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-default/50 flex min-h-32 flex-col items-center justify-center gap-2 p-4 text-center",
        className,
      )}
    >
      <ShieldAlertIcon className="text-muted size-8" />
      <p className="text-sm font-medium">Image could not be generated</p>
      {reason && <p className="text-muted text-xs">{reason}</p>}
    </div>
  );
}
...
function RegenerateButton({
  ...
  return (
    <button
      ...
      className="hover:bg-default inline-flex size-7 items-center justify-center rounded disabled:opacity-50"
    >
      <RefreshCwIcon
  ...
  return (
    ...
    >
      <button
        ...
        className="hover:bg-default inline-flex size-7 items-center justify-center rounded"
      >
