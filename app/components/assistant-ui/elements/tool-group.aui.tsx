...
const toolGroupVariants = cva("aui-tool-group-root group/tool-group w-full", {
  variants: {
    variant: {
      ...
      ghost: "",
      muted: "border-muted/30 bg-default/30 rounded-lg border py-3",
    },
  },
  ...
  return (
    <Disclosure.Heading>
      <Disclosure.Trigger
        ...
        className={cn(
          "aui-tool-group-trigger group/trigger flex origin-left items-center gap-2 text-xs transition-[color,transform] active:scale-[0.96]",
          "group-data-[variant=ghost]/tool-group-root:text-muted group-data-[variant=ghost]/tool-group-root:hover:text-foreground group-data-[variant=ghost]/tool-group-root:py-1",
    ...
    >
      <div
        className={cn(
          ...
          "group-data-[variant=outline]/tool-group-root:mt-2 group-data-[variant=outline]/tool-group-root:border-t group-data-[variant=outline]/tool-group-root:px-4 group-data-[variant=outline]/tool-group-root:pt-2",
          "group-data-[variant=muted]/tool-group-root:mt-2 group-data-[variant=muted]/tool-group-root:border-t group-data-[variant=muted]/tool-group-root:px-4 group-data-[variant=muted]/tool-group-root:pt-2",
          "[&>*]:animate-in [&>*]:fade-in-0 [&>*]:slide-in-from-top-1 [&>*]:animation-duration-150 [&>*]:ease-[cubic-bezier(0.32,0.72,0,1)]",
